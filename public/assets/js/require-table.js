    ...
    var Table = {
        ...
        api: {
            ...
            formatter: {
                ...
                promptt: function (value, row, index) {
                    var id = $(this).data("id");
                    return '<a href="javascript:;" class="'+this.field+'" onclick="'+this.field+'('+row.id+')" value = "'+row.id+'"  title="' + __('Click to search %s', value) + '" data-field="' + this.field + '" data-value="' + value + '">' + value + '</a>';
                },
                mp3: function (value, row, index) {
